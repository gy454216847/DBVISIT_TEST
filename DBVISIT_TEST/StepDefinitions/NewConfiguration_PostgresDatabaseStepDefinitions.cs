...
namespace DBVISIT_TEST.StepDefinitions
{
    ...
    public class NewConfiguration_PostgresDatabaseStepDefinitions
    {
        ...
        //[When(@"I input port and click connect button")]
        //public void WhenIInputPortAndClickConnectButton()
        //{
        ...
        //[When(@"I input (.*) and (.*)")]
        //public void WhenIInputYuAndJozaaai_U_Ijlsb_Ubmecoyv_Qicwi(string configuration_name,string license_key)
        //{
        ...
        [When(@"I input port (.*) and (.*) and click connect button")]
        public void WhenIInputPortPostgresAndPgAndClickConnectButton(string username,string passwords)
        {
            CommonWeb.Type(NewConfigurationPage.PortNnumerInput, "5432");
            CommonWeb.Click(NewConfigurationPage.ConnectToClusterButton);
            CommonWeb.Type(NewConfigurationPage.UsernameInput, username);
